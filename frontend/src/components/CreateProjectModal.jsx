...
//   const handleKeyPointChange = (category, itemId) => {
//     setKeyPoints((prev) => ({
//       ...prev,
...
//         ...keyPoints.entityInformation.filter(item => item.checked).map(item => item.label),
//         ...keyPoints.financialData.filter(item => item.checked).map(item => item.label),
//         ...keyPoints.contactInformation.filter(item => item.checked).map(item => item.label),
//       ];
  
//       if (selectedFieldNames.length === 0) {
//         alert("Please select at least one key point.");
//         return;
//       }
...
//                 </Typography>
//                 <FormGroup>
//                   {keyPoints.entityInformation.map((item) => (
//                     <FormControlLabel
//                       key={item.id}
//                       control={
//                         <Checkbox
...
//                           onChange={() =>
//                             handleKeyPointChange("entityInformation", item.id)
//                           }
//                           size="small"
//                         />
//                       }
...
//                 </Typography>
//                 <FormGroup>
//                   {keyPoints.financialData.map((item) => (
//                     <FormControlLabel
//                       key={item.id}
//                       control={
//                         <Checkbox
//                           checked={item.checked}
//                           onChange={() =>
//                             handleKeyPointChange("financialData", item.id)
//                           }
//                           size="small"
//                         />
//                       }
...
//                 </Typography>
//                 <FormGroup>
//                   {keyPoints.contactInformation.map((item) => (
//                     <FormControlLabel
//                       key={item.id}
//                       control={
//                         <Checkbox
//                           checked={item.checked}
//                           onChange={() =>
//                             handleKeyPointChange("contactInformation", item.id)
//                           }
//                           size="small"
//                         />
//                       }
